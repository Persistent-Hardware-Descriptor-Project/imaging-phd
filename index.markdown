...
<div class="feature-row left bg-gray">
  ...
  <div class="feature-text">
    ...
    <p>Microscopy metadata is often scattered across lab notebooks, instrument hardware specifications, image files, and quality-control and image analysis logs. Connecting these fragments is essential: Persistent Identifiers (PIDs) link the data, to the research resources used to produce it, to the researchers and ultimately to publications that resulted from the work. 
...
(PIDINST)</a>, which in turn links to a standardized, machine-readable description of the instrument's hardware configuration, which is called a Persistent Hardware Descriptor (PHD).</p>
  </div>
</div>
...
<div class="feature-row left bg-gray">
  ...
  <div class="feature-text">
    ...
    <p>Imaging-PHD builds on the existing <a href="https://wu-bimac.github.io/MicroMetaApp.github.io/">Micro-Meta App</a>, providing a streamlined tool for documenting the hardware descriptor of individual instruments. Each published instrument record receives a unique, permanent identifier, linking specific microscopes to their Persistent Hardware Descriptors (PHD), their home core facilities (via  <a href="https://coremarketplace.org/"> CoreMarketplace</a> and <a href="https://rrid.site/"> RRID</a>), the data they generate, and the researchers who use them.
    A searchable registry allows scientists to discover instruments with particular features and compare equipment across labs and institutions. By leveraging the community-driven Light Microscopy Model <a href="https://quarep.org/working-groups/wg-7-metadata/Limi-model/"> (LiMi-Model)</a> of metadata specifications maintained by  <a href="https://quarep.org/">
QUAREP-LiMi</a> to standardize how instruments are described and identified, Imaging-PHD improves the reliability of scientific results, gives proper credit to core facility staff, and makes advanced imaging technologies more accessible to the broader research community.</p>
  </div>
</div>
